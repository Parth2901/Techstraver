...
'''This language translator, built using Python and Tkinter, helps you understand and speak different 
languages easily. It uses Googletrans, a smart tool like a big dictionary, to translate words for you. 
Inspired by projects on GitHub. 
I made it simple and efficient. Just type in the text you want to translate, and translator will do the rest!'''
